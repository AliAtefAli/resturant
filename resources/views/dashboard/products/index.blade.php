                                                ...
                                                <table class="table table-striped table-bordered dom-jQuery-events">
                                                    ...
                                                    @foreach($products as $product)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="">
                                                                    <a href="{{ route('dashboard.products.edit', $product) }}" class="btn btn-info btn-sm" title="">
                                                                        <i class="ft-edit"></i>
                                                                    </a>
                                                                </a>
                                                                <form action="{{ route('dashboard.products.destroy', $product) }}" id="delete-confirm" method="post"
                                                                      style="display: inline-block">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                                            id="confir-text"><i class="ft-trash-2"></i>
                                                                    </button>
                                                                </form>
                                                            </td>
                                                        </tr>
