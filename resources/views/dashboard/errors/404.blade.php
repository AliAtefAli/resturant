...
<head>
    ...
    <title>Error 403 - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin
        Dashboard
    </title>
                      ...
                      <button class="btn btn-lg btn-secondary border-grey border-lighten-1" type="button"><i class="ft-search"></i></button>
                            ...
                            <div class="row py-2">
                                <div class="col-12 col-sm-6 col-md-6">
                                    <a href="{{route('home')}}" class="btn btn-primary btn-block"><i class="ft-home"></i> Back to Home</a>
                                </div>
                                <div class="col-12 col-sm-6 col-md-6">
...
<!-- END MODERN JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{asset('dashboard_files/app-assets/js/scripts/forms/form-login-register.js')}}" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
</body>
</html>