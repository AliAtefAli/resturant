...
@else
    <!-- BEGIN LTR CSS-->
        ...
        <link rel="stylesheet" type="text/css"
              href="{{asset('dashboard_files/app-assets/css/core/colors/palette-gradient.css')}}">
        <link rel="stylesheet" type="text/css"
              href="{{asset('dashboard_files/app-assets/vendors/css/cryptocoins/cryptocoins.css')}}">
...
<!-- DataTable css -->
    @if(lang() == 'ar')
        <link rel="stylesheet" type="text/css"
              href="{{asset('dashboard_files/app-assets/vendors/css/tables/extensions/datatables.ar.css')}}">
...
<script src="{{asset('dashboard_files/app-assets/vendors/js/tables/datatable/datatables.min.js')}}"
        type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/tables/datatable/dataTables.buttons.min.js')}}"
        type="text/javascript"></script>

<script src="{{asset('dashboard_files/app-assets/vendors/js/extensions/sweetalert.min.js')}}"
        type="text/javascript"></script>

<script src="{{asset('dashboard_files/app-assets/vendors/js/tables/buttons.flash.min.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('dashboard_files/app-assets/vendors/js/tables/buttons.html5.min.js')}}"
        type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/tables/buttons.print.min.js')}}"
        type="text/javascript"></script>

<script src="{{asset('dashboard_files/app-assets/vendors/js/charts/chart.min.js')}}" type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/charts/echarts/echarts.js')}}"
        type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/charts/echarts/chart/line.js')}}"
        type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/charts/echarts/chart/scatter.js')}}"
        type="text/javascript"></script>
<script src="{{asset('dashboard_files/app-assets/vendors/js/charts/echarts/chart/k.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('dashboard_files/app-assets/js/scripts/tables/datatables/datatable-advanced.js')}}"
        type="text/javascript"></script>
<script
    src="{{ asset('dashboard_files/app-assets/js/scripts/tables/datatables-extensions/datatable-button/datatable-html5.min.js') }}"></script>
<!-- End of Datatable js -->

<!-- SweetAlert js -->
<script src="{{asset('dashboard_files/app-assets/js/scripts/extensions/sweet-alerts.js')}}"
        type="text/javascript"></script>
