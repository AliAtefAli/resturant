...
@section('title', trans('dashboard.settings.Edit Settings'))
@section('styles')
                            ...
                            <form class="form-horizontal" method="post"
                                ...
                                @foreach(config('app.languages') as $key => $language)
                                    <div class="form-body">
                                        <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                                            <label class="col-md-2"
                                                   for="{{$key}}.who_are_we">{{ trans('dashboard.settings.Site Who are we ' . $language) }}</label>
                                            <div class="col-md-10">
                                                <input id="settings[{{$key}}_who_are_we]" type="hidden"
                                                       name="settings[{{$key}}_who_are_we]"
                                                       value="@if(isset($settings[$key.'_who_are_we'])) {{$settings[$key.'_who_are_we']}} @endif">
                                                <trix-editor input="settings[{{$key}}_who_are_we]"></trix-editor>
                                                @include('dashboard.partials._errors', ['input' => "$key.who_are_we"])
                                                <div class="form-control-position">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @foreach(config('app.languages') as $key => $language)
                                    <div class="form-body">
                                        <div
                                            class="form-group row {{ $errors->has('footer_text') ? ' has-error' : '' }}">
                                            <label class="col-md-2"
                                ...
                                <div class="form-group row {{ $errors->has('menu_of_the_week') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <div class="position-relative ">
                                            <input type="file" id="menu_of_the_week"
                                                   class="form-control image img-input"
