                            ...
                            <form class="form-horizontal" method="post"
                                ...
                                @foreach(config('app.languages') as $key => $language)
                                    <div class="form-body">
                                        <div class="form-group row">
                                            <label
                                                    class="col-md-2">{{ trans('dashboard.main.Products In ' . $language) }}</label>
                                            <div class="col-md-10">
                                                <input id="{{$key}}.products" type="hidden"
                                                       name="{{$key}}[products]"
                                                       value="">
...
{{--                                </div>--}}
                                ...
                                <div class="form-group row {{ $errors->has('delivery_price') ? ' has-error' : '' }}">
                                    <label class="col-md-2"
                                           for="durations_in_day">{{trans('dashboard.delivery_price')}}</label>
                                    <div class="col-md-10">
                                        <div class="position-relative ">
