...
@section('title', trans('dashboard.meals.edit_meal'))
@section('styles')
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('dashboard.meals.edit_meal') }}</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="post"
                                  action="{{ route('dashboard.meals.update',$meals) }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-body">
                                    <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="text" name="name" value="{{ $meals->name }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <img src="{{ asset('assets/uploads/meals/' . $meals->image) }}"
