                ...
                @if(isset($rate))
                    <div>
                        <div class="stars-section d-flex justify-content-center">
                            <input class="star star-5" id="star-5" type="radio" name="amount" value="5" @if($rate->amount == 5) checked @endif/>
                            <label class="star star-5" for="star-5"></label>
                            <input class="star star-4" id="star-4" type="radio" name="amount" value="4" @if($rate->amount == 4) checked @endif/>
                            <label class="star star-4" for="star-4"></label>
                            <input class="star star-3" id="star-3" type="radio" name="amount" value="3" @if($rate->amount == 3) checked @endif/>
                            <label class="star star-3" for="star-3"></label>
                            <input class="star star-2" id="star-2" type="radio" name="amount" value="2" @if($rate->amount == 2) checked @endif/>
                            <label class="star star-2" for="star-2"></label>
                            <input class="star star-1" id="star-1" type="radio" name="amount" value="1" @if($rate->amount == 1) checked @endif/>
                    ...
                    <label class="input-style">
                        <textarea name="comment">{{ $rate->comment }}</textarea>
