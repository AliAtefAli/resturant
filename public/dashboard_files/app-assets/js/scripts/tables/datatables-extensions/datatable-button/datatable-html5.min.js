...
$(document).ready(function () {
    $(".dataex-html5-export").DataTable({
        ...
        dom: "Bfrtip",
        buttons: ["copyHtml5", {extend: "csvHtml5", fieldSeparator: "\t", extension: ".tsv"}]
    }), $(".dataex-html5-selectors").DataTable({
        dom: "Bfrtip",
        buttons: [{extend: "copyHtml5", exportOptions: {columns: [0, ":visible"]}}, {
            extend: "excelHtml5",
            exportOptions: {columns: ":visible"}
        }, {extend: "pdfHtml5", exportOptions: {columns: [0, 1, 2, 5]}}, "colvis"]
        ...
        buttons: [{
            extend: "excelHtml5", customize: function (xlsx) {
                ...
                $('row c[r^="F"]', sheet).each(function () {
                    1 * $("is t", this).text().replace(/[^\d]/g, "") >= 5e5 && $(this).attr("s", "20")
                })
            }
        }]
    }), $(".dataex-html5-message").DataTable({
        dom: "Bfrtip",
        buttons: [{extend: "pdfHtml5", message: "PDF created by PDFMake with Buttons for DataTables."}]
    }), $(".dataex-html5-orientation").DataTable({
        dom: "Bfrtip",
        buttons: [{extend: "pdfHtml5", orientation: "landscape", pageSize: "LEGAL"}]
